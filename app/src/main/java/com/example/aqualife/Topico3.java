...
public class Topico3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico3);
        ...
        sharedPrefManager.saveLastActivityId(txtNome, 6);

        btnAvancar.setOnClickListener(v -> {
            Intent intent = new Intent(Topico3.this, Topico3_t1.class);
        ...
        btnVoltar.setOnClickListener(v -> {
            Intent intent = new Intent(Topico3.this, Topico2_zquiz5.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
        ...
        btnHome.setOnClickListener(v -> {
            Intent intent = new Intent(Topico3.this, MainActivity.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
