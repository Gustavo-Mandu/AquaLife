...
public class Topico1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico1);
        ...
        sharedPrefManager.saveLastActivityId(txtNome, 1);


        btnAvancar.setOnClickListener(v -> {
            Intent intent = new Intent(Topico1.this, Topico1_t1.class);
        ...
        btnVoltar.setOnClickListener(v -> {
            Intent intent = new Intent(Topico1.this, MainActivity.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
