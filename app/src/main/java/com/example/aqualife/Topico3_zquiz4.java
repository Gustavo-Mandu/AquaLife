...
public class Topico3_zquiz4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico3_zquiz4);
        ...
        btnCheck.setOnClickListener(v -> {
            if (rdioButton1.isChecked()){
                ...
                rdioButton3.setBackgroundResource(R.drawable.container_radiobutton_correct);
            } else
        ...
        btnContinue.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico3_zquiz5.class);
