...
public class Topico3_zquiz2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico3_zquiz2);
        ...
        btnContinue.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico3_zquiz3.class);
        ...
        btnVoltar.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico3_zquiz1.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
