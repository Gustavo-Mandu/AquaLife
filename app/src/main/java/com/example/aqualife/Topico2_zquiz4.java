...
public class Topico2_zquiz4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico2_zquiz4);
        ...
        btnContinue.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico2_zquiz5.class);
        ...
        btnVoltar.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico2_zquiz3.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
