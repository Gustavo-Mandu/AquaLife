...
public class Topico4_zquiz3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico4_zquiz3);
        ...
        btnContinue.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico4_zquiz4.class);
        ...
        btnVoltar.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico3_zquiz2.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
