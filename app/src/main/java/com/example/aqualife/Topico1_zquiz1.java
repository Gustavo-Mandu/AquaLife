...
public class Topico1_zquiz1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico1_zquiz1);
       ...
       btnContinue.setOnClickListener(v -> {
        ...
        btnVoltar.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico1_t2.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
