...
public class Topico5_zquiz4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico5_zquiz4);
        ...
        btnContinue.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico5_zquiz5.class);
