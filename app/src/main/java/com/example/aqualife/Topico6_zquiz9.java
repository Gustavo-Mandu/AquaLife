...
public class Topico6_zquiz9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico6_zquiz9);
        ...
        btnCheck.setOnClickListener(v -> {
            if (rdioButton1.isChecked()){
                rdioButton1.setBackgroundResource(R.drawable.container_radiobutton_correct);
            ...
            if (rdioButton4.isChecked()) {
                rdioButton4.setBackgroundResource(R.drawable.container_radiobutton_incorrect);
                btnCheck.setText("Errou!");
                btnCheck.setEnabled(false);
                btnCheck.setBackgroundResource(R.drawable.background_button_enabled);
                rdioButton1.setBackgroundResource(R.drawable.container_radiobutton_correct);
        ...
        btnContinue.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico6_zquiz10.class);
        ...
        btnVoltar.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico6_zquiz8.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
