...
public class Topico2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico2);
        ...
        sharedPrefManager.saveLastActivityId(txtNome, 4);

        btnAvancar.setOnClickListener(v -> {
            Intent intent = new Intent(Topico2.this, Topico2_t1.class);
        ...
        btnVoltar.setOnClickListener(v -> {
            Intent intent = new Intent(Topico2.this, Topico1_zquiz5.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
        ...
        btnHome.setOnClickListener(v -> {
            Intent intent = new Intent(Topico2.this, MainActivity.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
