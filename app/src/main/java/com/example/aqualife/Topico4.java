...
public class Topico4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico4);
        ...
        sharedPrefManager.saveLastActivityId(txtNome, 8);

        btnAvancar.setOnClickListener(v -> {
            Intent intent = new Intent(Topico4.this, Topico4_t1.class);
        ...
        btnVoltar.setOnClickListener(v -> {
            Intent intent = new Intent(Topico4.this, Topico3_zquiz5.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
        ...
        btnHome.setOnClickListener(v -> {
            Intent intent = new Intent(Topico4.this, MainActivity.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
