...
public class Topico6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico6);
        ...
        sharedPrefManager.saveLastActivityId(txtNome, 12);

        btnAvancar.setOnClickListener(v -> {
            Intent intent = new Intent(Topico6.this, Topico6_t1.class);
        ...
        btnVoltar.setOnClickListener(v -> {
            Intent intent = new Intent(Topico6.this, Topico5_zquiz5.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
        ...
        btnHome.setOnClickListener(v -> {
            Intent intent = new Intent(Topico6.this, MainActivity.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
