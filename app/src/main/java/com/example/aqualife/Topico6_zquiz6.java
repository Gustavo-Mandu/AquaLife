...
public class Topico6_zquiz6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_layout_topico6_zquiz6);
        ...
        btnCheck.setOnClickListener(v -> {
            if (rdioButton1.isChecked()){
                ...
                rdioButton2.setBackgroundResource(R.drawable.container_radiobutton_correct);
            } else
        ...
        btnContinue.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico6_zquiz7.class);
        ...
        btnVoltar.setOnClickListener(v -> {
            Intent intent = new Intent(getApplicationContext(), Topico6_zquiz5.class);
            intent.putExtra("editUsername", txtNome);
            intent.putExtra("editPassword", txtSenha);
            startActivity(intent);
            finish();
